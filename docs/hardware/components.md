...
with a combined capacity of 24,800mAh enable a continuous monitoring of about
...
different camera sensors are available. The cheaper
[OAK-1 Lite](https://docs.luxonis.com/projects/hardware/en/latest/pages/NG9096.html){target=_blank}
has a lower quality camera sensor, which might be good enough depending on your use case.
...
[automated monitoring script](../software/programming.md#automated-monitoring-script){target=_blank}
is limited to a maximum resoltion of 3840x2160 pixel (4K). Therefore the OAK-1 MAX
